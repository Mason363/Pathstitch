...
impl Surface {
                                     ...
                                     verts: &mut Vec<Vertex>)
    {
        ...
        // Interior sample grid (num_pts × num_pts) per surface type. Pathstitch
        // change: doubly-curved surfaces were tessellated too coarsely, so
        // spheres/ellipsoids looked faceted and freeform NURBS/B-spline faces
        // collapsed to a few flat triangles in the STEP QuickLook previews.
        // Bump the sphere grid and add interior samples for NURBS/B-spline.
        // Cylinders, cones and planes are developable/flat — boundary sampling
        // alone is exact, so they stay at 0 (and render perfectly round).
