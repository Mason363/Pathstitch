...
enum AppCommands {
    ...
    static let all: [AppCommand] = [
        ...
        .init(id: "tool.arc", title: "Arc Sketch", icon: "compass.drawing", category: "Tools",
              defaultCombo: KeyCombo(key: "")) { $0.currentTool = .sketchArc },
        .init(id: "tool.conic", title: "Conic Curve Sketch", icon: "point.topleft.down.to.point.bottomright.curvepath", category: "Tools",
              defaultCombo: KeyCombo(key: "")) { $0.currentTool = .sketchConic },
